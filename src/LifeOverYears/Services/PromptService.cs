...
public sealed class PromptService : IPromptService
{
    ...
    public async Task<Prompt> BuildAsync(SceneDna sceneDna, EraProfile eraProfile, GenerationContext context)
    {
        ...
        var sceneBlock = BuildSceneBlock(eraProfile, sceneContent, sceneType, condition, gasSign, cornerShop, hasBackgroundBuildings, rng, context);
    ...
    private static string BuildSceneBlock(EraProfile era, SceneContent? content, string sceneType, string condition, GenerationContext.GasSign gasSign, GenerationContext.CornerShopSign cornerShop, bool hasBackgroundBuildings, Random rng, GenerationContext context)
    {
        var sb = new StringBuilder();
