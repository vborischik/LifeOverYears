...
Generated: 2026-08-09T17:11:32.8366110+00:00
...
| V1 | Video file exists and has non-zero size | ✅ PASS | 337884 bytes at output/smoke-video/video/timeline.mp4 |
...
| V6 | ffmpeg used filter_complex xfade (not concat) with one pooled transition per cut, all distinct across 6 frames | ✅ PASS | ffmpeg command: -y -loop 1 -t 2.8 -i "/Users/vlad/Projects/LifeOverYears/src/LifeOverYears/output/smoke-video/stamped/1975.png" -loop 1 -t 3.64 -i "/Users/vlad/Projects/LifeOverYears/src/LifeOverYears/output/smoke-video/stamped/1985.png" -loop 1 -t 3.64 -i "/Users/vlad/Projects/LifeOverYears/src/LifeOverYears/output/smoke-video/stamped/1995.png" -loop 1 -t 3.64 -i "/Users/vlad/Projects/LifeOverYears/src/LifeOverYears/output/smoke-video/stamped/2005.png" -loop 1 -t 3.64 -i "/Users/vlad/Projects/LifeOverYears/src/LifeOverYears/output/smoke-video/stamped/2015.png" -loop 1 -t 3.64 -i "/Users/vlad/Projects/LifeOverYears/src/LifeOverYears/output/smoke-video/stamped/2025.png" -filter_complex "[0:v]scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:(ow-iw)/2:(oh-ih)/2,setsar=1,fps=30,format=yuv420p[v0];[1:v]scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:(ow-iw)/2:(oh-ih)/2,setsar=1,fps=30,format=yuv420p[v1];[2:v]scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:(ow-iw)/2:(oh-ih)/2,setsar=1,fps=30,format=yuv420p[v2];[3:v]scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:(ow-iw)/2:(oh-ih)/2,setsar=1,fps=30,format=yuv420p[v3];[4:v]scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:(ow-iw)/2:(oh-ih)/2,setsar=1,fps=30,format=yuv420p[v4];[5:v]scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:(ow-iw)/2:(oh-ih)/2,setsar=1,fps=30,format=yuv420p[v5];[v0][v1]xfade=transition=smoothright:duration=1:offset=1.8[x1];[x1][v2]xfade=transition=fade:duration=1:offset=4.44[x2];[x2][v3]xfade=transition=circleopen:duration=1:offset=7.08[x3];[x3][v4]xfade=transition=radial:duration=1:offset=9.72[x4];[x4][v5]xfade=transition=smoothleft:duration=1:offset=12.36[outv]" -map "[outv]" -c:v libx264 -pix_fmt yuv420p -r 30 "output/smoke-video/video/timeline.mp4" |
