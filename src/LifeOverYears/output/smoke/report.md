...
| C7 | The oldest era is monochrome exactly when Pipeline:MonochromeFirstEra is on; every later era is colour | ✅ PASS | MonochromeFirstEra=True: 1975 black and white, 5 later eras colour |
...
| C52 | The 'restored' descriptor reads as reoccupation of the same shell, not a renovation | ✅ PASS | 53 restored finales, all reoccupation wording |
